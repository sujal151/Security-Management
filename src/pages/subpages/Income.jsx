...
const IncomeDetails = ({data}) => {
  ...
  return (
    <div>
      <div className="mt-6 p-5 rounded-lg shadow-md flex justify-between items-center bg-white">
        <div className="flex flex-wrap gap-3">
          <div className="p-6 rounded-lg shadow-md border-r-2 border-r-orange-500 flex justify-between items-center w-[236px] h-[105px]">
            <div>
      ...
      {showMaintenanceModal && (
        <MaintenancePassword
          ...
          closeModal={() => setShowMaintenanceModal(false)}
        />
      )}
